...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    ================================================== -->
        <meta charset="utf-8">
        <title>Intive Studio - Inovation Creative Startup</title>
        <meta name="description" content="Intive Studio - Inovation Creative Startup">
           	...
           	<div class="carousel-inner">
           	 	<div class="item active">
           	 		<div class="overlay-slide">
           	 			<img src="images/bg/background.jpg" alt="" class="img-responsive">
           	 		</div>
                ...
                <div class="item">
                    <div class="overlay-slide">
                        <img src="images/bg/background-2.jpg" alt="" class="img-responsive">
           	 		</div>
           	 		<div class="carousel-caption">
               	 		<div class="col-md-12 col-xs-12 text-center">
                    <h2>Intive Studio</h2>
           	 	...
           	 	<div class="item">
                    <div class="overlay-slide">
                        <img src="images/bg/background-3.png" alt="" class="img-responsive">
           	 		</div>
           	 		<div class="carousel-caption">
               	 		<div class="col-md-12 col-xs-12 text-center">
                    <h2>Intive Studio</h2>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="feature_header text-center">
                            ...
                            <h4 class="feature_sub">What we can do for you ?</h4>
    ...
    <div class="container">
            ...
            <div class="about-desc">
                ...
                <!-- Left about end -->
                    <div class="col-md-6">
                        <div class="single-progress">
                            <label > Web Developing <span>90%</span></label>
                            <div class="progress">
                    ...
                    <div class="col-md-6">
                        <div class="single-progress">
                            <label > Mobile Apps <span>80%</span></label>
                            <div class="progress">
                ...
                <div class="row">
                    <div class="col-md-6">
                         <div class="single-progress">
                            <label > Digital Design <span>95%</span></label>
                            <div class="progress">
...
<!-- Portfolio works Start -->
    ...
    <div id="isotope-filter" class="skew3 text-center">
        ...
        <a data-filter=".android"  href="#" class="">Android</a>
        <a data-filter=".website" href="#"  class="">Website</a>
        <a data-filter=".graphic"  href="#" class="">Digital Design</a>
    </div>

    <div class="clearfix"></div>
   			<div class="text-center ">
              <ul class="portfolio-wrap" id="portfolio_items">
                    <li class="col-xs-12 col-sm-6 col-md-3 single-portfolio website">
                        <figure>
                            <img src="images/portfolio/p1.png" alt=""/>
                            <figcaption>
                                <h5>Poltek Padamara</h5>
                                <p class="links">
                                    <a href="#"> <i class="fa fa-link"></i></a>
                                    <a href="images/portfolio/p1.png" data-rel="prettyPhoto" class="img-responsive">
                                        <i class="fa fa-plus"></i>
                                    </a>
                                </p>
                                <p class="description">
                                    Website Berbasis PHP Untuk Politeknik Perdamaian Halmahera
                                </p>
                            </figcaption>
                        </figure>
                    </li>
                    ...
                    <li class="col-xs-12 col-sm-6 col-md-3 single-portfolio website">
                        <figure>
                        <img src="images/portfolio/p2.png" alt="" />
                            <figcaption>
                                <h5>Toko BWA</h5>
                                <p class="links">
                                    <a href="http://bwa.ikc.co.id"> <i class="fa fa-link"></i></a>
                                    <a href="images/portfolio/p2.png"  data-rel="prettyPhoto" class="img-responsive">
                                        <i class="fa fa-plus"></i>
                                    </a>
                                </p>
                                <p class="description">
                                    Online Shop Elektronik CV.Ide Kita Cemerlang
                                </p>
                                </figcaption>
                        </figure>
                    </li>
                    ...
                    <li class="col-xs-12 col-sm-6 col-md-3 single-portfolio website">
                        <figure>
                            <img src="images/portfolio/p3.png" alt="" />
                            <figcaption>
                                <h5>LuwakDev Simple Online Shop</h5>
                                <p class="links">
                                    <a href="portfolio-single.html"> <i class="fa fa-link"></i></a>
                                    <a href="images/portfolio/p3.png" data-rel="prettyPhoto" class="img-responsive">
                                        <i class="fa fa-plus"></i>
                                    </a>
                                </p>
                                <p class="description">
                                    Luwakdev E-Commerce HTML5 Template
                                </p>
                            </figcaption>
                        </figure>
                    </li>

                    <li class="col-xs-12 col-sm-6 col-md-3 single-portfolio website graphic">
                        <figure>
                            <img src="images/portfolio/p4.png" alt="" />
                            <figcaption>
                                <h5>Revolution Magazine - Madig</h5>
                                <p class="links">
                                    <a href="portfolio-single.html"> <i class="fa fa-link"></i></a>
                                    <a href="images/portfolio/p4.png" data-rel="prettyPhoto" class="img-responsive">
                                        <i class="fa fa-plus"></i>
                                    </a>
                                </p>
                                <p class="description">
                                    Revmagz adalah Sebuah Madig yang dibuat oleh sekumpulan orang tamvan
                                </p>
                            </figcaption>
                        </figure>
                    </li>

                    <li class="col-xs-12 col-sm-6 col-md-3 single-portfolio android">
                        <figure>
                            <img src="images/portfolio/p5.png" alt="" />
                            <figcaption>
                                <h5>Sports Zusammen</h5>
                                <p class="links">
                                    <a href="portfolio-single.html"> <i class="fa fa-link"></i></a>
                                    <a href="images/portfolio/p5.png" data-rel="prettyPhoto" class="img-responsive">
                                        <i class="fa fa-plus"></i>
                                    </a>
                                </p>
                                <p class="description">
                                    Android APPS for Learning Germany A1
                                </p>
                            </figcaption>
                        </figure>
                    </li>
                    ...
                    <li class="col-xs-12 col-sm-6 col-md-3 single-portfolio website">
                        <figure>
                            <img src="images/portfolio/p6.png" alt="" />
                            <figcaption>
                                <h5>Vidcom - E Commerce</h5>
                                <p class="links">
                                    <a href="portfolio-single.html"> <i class="fa fa-link"></i></a>
                                    <a href="images/portfolio/p6.png" data-rel="prettyPhoto" class="img-responsive">
                                        <i class="fa fa-plus"></i>
                                    </a>
                                </p>
                                <p class="description">
                                    Website E-Commerce Laptop dan Komputer
                                </p>
                            </figcaption>
                        </figure>
                    </li>
                    ...
                    <li class="col-xs-12 col-sm-6 col-md-3 single-portfolio website">
                        <figure>
                            <img src="images/portfolio/p7.png" alt="" />
                            <figcaption>
                                <h5>Satline</h5>
                                <p class="links">
                                    <a href="portfolio-single.html"> <i class="fa fa-link"></i></a>
                                    <a href="images/portfolio/p7.png" data-rel="prettyPhoto" class="img-responsive">
                                        <i class="fa fa-plus"></i>
                                    </a>
                                </p>
                                <p class="description">
                                    Sistem Informasi Satpam Online
                                </p>
                            </figcaption>
                        </figure>
                    </li>
                    ...
                    <li class="col-xs-12 col-sm-6 col-md-3 single-portfolio website">
                        <figure>
                            <img src="images/portfolio/p8.png" alt="" />
                            <figcaption>
                                <h5>Carikendaraan.id</h5>
                                <p class="links">
                                    <a href="https://carikendaraan.id"> <i class="fa fa-link"></i></a>
                                    <a href="images/portfolio/p8.png" data-rel="prettyPhoto" class="img-responsive">
                                        <i class="fa fa-plus"></i>
                                    </a>
                                </p>
                                <p class="description">
                                    Website Pembanding Harga, Salah Satu Partner Ubig.co.id
                                </p>
                            </figcaption>
                        </figure>
                    </li>
                    ...
                    <div class="tab-content main-tab-content">
                          <div role="tabpanel" class="tab-pane active " id="home">
                                <div class="col-md-12 col-sm-9">
                                     <img src="images/bg/web.png" alt="" class="img-responsive">
                                </div>
                                <div class="col-md-12 col-sm-9">
                                    <div class="c-tab">
                          ...
                          <div role="tabpanel" class="tab-pane" id="profile">
                                <div class="col-md-12 col-sm-9">
                                     <img src="images/bg/andro.jpg" alt="" class="img-responsive">
                                </div>
                                <div class="col-md-12 col-sm-9">
                                    <div class="c-tab">
                          ...
                          <div role="tabpanel" class="tab-pane" id="messages">
                               <div class="col-md-12 col-sm-9">
                                     <img src="images/bg/design.jpg" alt="" class="img-responsive">
                                </div>
                               <div class="col-md-12 col-sm-9">
                                    <div class="c-tab">
                ...
                <div class="col-md-3 col-xs-12 col-sm-6 columns">
                    <div class="facts-wrap">
                     <div class="graph">
                        ...
                        <i class="fa fa-cog fa-3x fw"></i>
                        <div class="facts-wrap-num"><span class="counter">69</span></div>
                        </div>
                        <h6>Coffe</h6>
                    </div>
                </div>
                 ...
                 <div class="col-md-6 ">
                    <div class="landing-video">
                        <div class="video-embed wow fadeIn" data-wow-duration="1s">
                                <!-- Change the url -->
                            <iframe width="350" height="281" src="https://www.youtube.com/embed/X-b2Zrr8BEk" frameborder="0" allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 ">
                    <div class="video-text">
                            ...
                            <div class="panel-heading active" role="tab" id="headingOne">
                              <h4 class="panel-title">
                                <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                  Apa Kelebihan Intive Studio ?
                                </a>
                              </h4>
                            </div>
                            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                              <div class="panel-body p1">
                                Dari studi kasus kami, salah satu kemudahan fundamental di Intive Studio adalah kemudahan akses untuk tata kelola halaman admin, jadi siapa saja bisa go online, dan tim kami siap sedia untuk berdiskusi dan konsultasi.
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="panel-heading " role="tab" id="headingTwo">
                          <h4 class="panel-title">
                            <a class="accordion-toggle collapsed"  data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                              Berapa Lama Proses Kerjanya ?
                            </a>
                          </h4>
                        </div>
                        <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                          <div class="panel-body p1">
                            Untuk standart website, kami kerjakan dalam durasi waktu 10 hari kerja, serta tambahan revisi (jika ada) dengan durasi waktu 3-4 hari, untuk custom web sistem, waktu proses menyesuaikan tingkat kerumitan pesanan.
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="panel panel-default">
                        ...
                        <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                          <div class="panel-body p1">
                            Selama kerjasama, Intive Studio akan bertanggung jawab sepenuhnya ketika ada kendala dalam masalah website, termasuk juga dalam hal keamanan website. tim teknis aksamedia akan siap sedia membantu dan memantau website client.
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading " role="tab" id="headingFour">
                          <h4 class="panel-title">
                            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="false" aria-controls="collapseThree">
                              Bonus spesial untuk seluruh client ?
                            </a>
                          </h4>
                        </div>
                        <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                          <div class="panel-body p1">
                            Kita akan bantu untuk memantau trafic yang nantinya kita akan bantu secara berkala berdasarkan data, apa yang sebaiknya dilakukan untuk web client, termasuk kita akan selalu share ilmu dan info-info terbaru dunia internet marketing.
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading " role="tab" id="headingFive">
                          <h4 class="panel-title">
                            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFive" aria-expanded="false" aria-controls="collapseThree">
                              Biaya perpanjangan per tahun berapa ?
                            </a>
                          </h4>
                        </div>
                        <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
                          <div class="panel-body p1">
                            Biaya perpanjangan tahunan website dan garansi di Intive Studio cukup terjangkau, untuk standart website biaya perpanjangan tahunan Rp.400.000 sudah meliputi perpanjangan domain + hosting dan garansi up time 1 tahun berikutnya.
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div id="testimonial-carousel" class="owl-carousel owl-theme text-center testimonial-slide">
                        <div class="item">
                          <div class="testimonial-thumb">
                            <img class="img-circle" src="images/slider/b6.jpg" alt="testimonial" >
                          </div>
        ...
        <div class="row wow fadeInLeft">
          <div id="client-carousel" class="col-sm-12 owl-carousel owl-theme text-center client-carousel">
            <div class="item client_logo">
              <a href="#">
                <img src="images/clients/client1.gif" alt="client" class="img-responsive">
              </a>
            </div>
            <div class="item client_logo">
              <a href="#">
